...
2.  **새로 만들기**를 클릭하고 **자동화**, **클라우드 흐름**, **자동화됨**을 선택합니다. 그러면 새 창에서 Power Automate 흐름 편집기가 열립니다.

3. **흐름 트리거 선택**에서 **Microsoft Dataverse**를 검색합니다.

4. **행이 추가, 수정 또는 삭제될 때** 트리거를 선택한 후에 **만들기**를 클릭합니다.
...
9. *메일*을 검색하고, **Office 365 Outlook** 커넥터를 선택하고, **전자 메일 보내기(V2)** 작업을 선택합니다.
...
2. **새로 만들기**를 클릭하고 **자동화**, **클라우드 흐름**, **예약됨**을 선택합니다. 그러면 새 창에서 Power Automate 흐름 편집기가 열립니다.

3. 흐름이 **15**분마다 반복되도록 설정합니다.
...
10.  이메일 알림 보내기
     ...
     * 각 루프에 적용 내부의 **작업 추가**를 클릭합니다. **Office 365 Outlook** 연결로부터 **전자 메일 보내기(V2)** 작업을 추가합니다.
...
13.  **본문** 필드에 다음을 입력합니다. **이름**은 **건물 받기** 단계의 동적 콘텐츠입니다. 목록의 맨 아래까지 스크롤해야 할 수도 있습니다.
