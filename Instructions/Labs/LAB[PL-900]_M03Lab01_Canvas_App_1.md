...
6.  상단의 수식 막대에서 **ThisItem.'Created On'** 를 `ThisItem.'Scheduled Start'`으로 변경합니다.
...
10.  상단의 수식 막대에서 **ThisItem.'Scheduled Start'** 을 `ThisItem.'Scheduled End'`로 변경합니다.
...
9. 식에서 **[@Visits]** 를 찾아 `Filter(Visits,'Scheduled End' >= DatePicker1.SelectedDate)`로 바꿉니다. 전체 식은 다음과 같아야 합니다.
