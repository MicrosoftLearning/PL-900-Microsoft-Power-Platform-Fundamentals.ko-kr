...
9. **저장**을 클릭하고 변경 내용이 저장될 때까지 기다립니다.
...
5. 페이지 추가 화면에서  **테이블**을 선택한 다음, **다음** 단추를 선택합니다.
...
9. 탐색 창에서 탐색 모음이 표시된 아래의 **그룹 1**을 선택합니다. 왼쪽에 있는 메뉴를 확장해야 할 수도 있습니다.

10. 화면 오른쪽의 **표시 옵션** 섹션에서 **제목** 속성을 **보안**으로 변경합니다.

11. 탐색 창의 보안 그룹 아래에서 **SubArea1**을 선택합니다. 

12. **줄임표**를 선택한 후 표시되는 메뉴에서 **탐색에서 제거**를 선택합니다. 

13. **저장**을 선택하고 변경 내용이 저장될 때까지 기다립니다. 

14. **저장**이 완료되면 **게시** 단추를 선택하여 변경 내용을 게시합니다. 


### <a name="task-2-test-app"></a>작업 #2: 테스트 앱
