...
1.  오른쪽 위의 **환경** 메뉴에서 **연습** 환경이 선택되어 있는지 확인합니다. 
...
4.  왼쪽 위의 와플 단추를 선택하여 애플리케이션을 변경하고 **OneDrive**를 선택합니다. (OneDrive를 설정하는 데 몇 분 정도 걸릴 수 있습니다. 화면에 OneDrive가 표시되면 **OneDrive가 준비됨**을 선택합니다.)
...
2.  오른쪽 위의 **환경** 메뉴에서 **연습** 환경이 선택되어 있는지 확인합니다. 
