...
4.  왼쪽 상단에 있는 앱 시작 관리자(와플 단추)를 선택하여 애플리케이션을 변경하고 **OneDrive**를 선택합니다. (OneDrive를 설정하는 데 몇 분 정도 걸릴 수 있습니다. 화면에 OneDrive가 표시되면 **OneDrive가 준비됨**을 선택합니다.)
...
2.  오른쪽 상단의 **환경** 메뉴에서 **Dev One** 환경이 선택되어 있는지 확인합니다. 
