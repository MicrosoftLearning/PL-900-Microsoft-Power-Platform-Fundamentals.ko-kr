...
12. 방문자 조회 열 만들기
    ...
    6.  **관계 이름** 에 **visitor_id** 를 입력합니다.
    
    7.  **완료** 를 클릭합니다.

13. 오른쪽 하단에서 **테이블 저장** 을 클릭합니다.
...
8.  이전에 다운로드한 **Visits.xls** 파일을 찾아 선택합니다. *(참고: 파일 업로드에 1~2분 정도 소요될 수 있습니다. 맵핑 에러가 있다는 메시지가 나와도 걱정하지 마세요. 다음에 수정할 것입니다.)*
...
2.  방문 테이블에 대한 탭이 많이 있습니다. 여기에는 Cikynns, 관계, 비즈니스 규칙, 보기 등이 포함됩니다. 

3.  방문 테이블의 **데이터** 탭을 선택합니다. **테이블** \> **방문** 아래에 있습니다.

3.  테이블에 레코드가 있는지 확인합니다. 오른쪽 위에 있는 보기 이름을 선택하고 **모든 열** 로 변경하여 보기를 변경할 수 있습니다. 
